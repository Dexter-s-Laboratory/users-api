...
module.exports = {
  ...
  createUserInDB: (data) => {
    return db.query('INSERT INTO users (full_name, username, address_line_1, city, state_abbr, zip, phone_number, email, firebase_uid) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id', [data.fullName, data.username, data.addressOne, data.city, data.state, data.zip, data.phone, data.email, data.uid]);
  },
